...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        templates_json_path = os.path.join(
            base_dir, "apps", "core", "data", "templates.json"
        )
    ...
    def update_templates(self, json_path):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Error updating templates: {str(e)}"))
    ...
    def update_plans(self, json_path):
        ...
        try:
            ...
            for plan_data in plans_data:
                ...
                price_monthly = float(
                    monthly_cost_str.replace("₹", "").replace(",", "")
                )
            ...
            self.stdout.write(self.style.ERROR(f"Error updating plans: {str(e)}"))
